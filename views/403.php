<?php
$pageTitle = 'Access denied — Mini Blog';
...
<main id="main-content" tabindex="-1"
    ...
    <p class="text-7xl font-semibold uppercase tracking-[0.2em] text-stone-500">403</p>
    ...
    <p class="mt-4 max-w-md text-base leading-relaxed text-stone-600">
        This page is restricted. If you need access, ask a site owner.
    </p>
    <p class="mt-10">
