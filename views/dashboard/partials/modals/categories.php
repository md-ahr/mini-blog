        ...
        <div role="dialog" aria-modal="true" aria-labelledby="modal-category-add-title" tabindex="-1"
            ...
            <form class="space-y-4 px-5 py-4" action="#" method="get" onsubmit="return false;">
                <div>
                    ...
                    <input id="cat-add-name" name="category_name" type="text" class="<?= $fld ?>" placeholder="Journal"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-add-slug">Slug</label>
                    <input id="cat-add-slug" name="category_slug" type="text" class="<?= $fld ?> font-mono text-xs" placeholder="journal"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-add-color">Accent color</label>
                    <input id="cat-add-color" name="category_color" type="color" value="#57534e"
                ...
                <div>
                    ...
                    <textarea id="cat-add-desc" name="category_description" rows="4" class="<?= $fld ?>" placeholder="Archive intro copy."></textarea>
                </div>
            </form>
            <div class="flex flex-col-reverse gap-2 border-t border-stone-100 px-5 py-4 sm:flex-row sm:justify-end">
                ...
                <button type="button" class="<?= $btnPri ?> w-full sm:w-auto">Create category</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div role="dialog" aria-modal="true" aria-labelledby="modal-category-edit-title" tabindex="-1"
            ...
            <form class="space-y-4 px-5 py-4" action="#" method="get" onsubmit="return false;">
                <div>
                    ...
                    <input id="cat-edit-name" name="category_name" type="text" class="<?= $fld ?>"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-edit-slug">Slug</label>
                    <input id="cat-edit-slug" name="category_slug" type="text" class="<?= $fld ?> font-mono text-xs"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-edit-posts">Posts</label>
                    <input id="cat-edit-posts" name="category_posts" type="number" min="0" class="<?= $fld ?> tabular-nums"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-edit-color">Accent color</label>
                    <input id="cat-edit-color" name="category_color" type="color" value="#78716c"
                           class="mt-1.5 h-10 w-full cursor-pointer rounded-xl border border-stone-200 bg-white px-1 py-1 shadow-inner shadow-stone-900/5 focus:outline-none focus:ring-2 focus:ring-amber-500/30"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="cat-edit-desc">Description</label>
                    <textarea id="cat-edit-desc" name="category_description" rows="4" class="<?= $fld ?>"></textarea>
                </div>
            </form>
            <div class="flex flex-col-reverse gap-2 border-t border-stone-100 px-5 py-4 sm:flex-row sm:justify-end">
                <button type="button" data-modal-close class="<?= $btnSec ?> w-full sm:w-auto">Cancel</button>
