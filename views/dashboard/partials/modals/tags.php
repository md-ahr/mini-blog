        ...
        <div role="dialog" aria-modal="true" aria-labelledby="modal-tag-add-title" tabindex="-1"
            ...
            <form class="space-y-4 px-5 py-4" action="#" method="get" onsubmit="return false;">
                <div>
                    ...
                    <input id="tag-add-name" name="tag_name" type="text" class="<?= $fld ?>" placeholder="Studio log"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="tag-add-slug">Slug</label>
                    <input id="tag-add-slug" name="tag_slug" type="text" class="<?= $fld ?>" placeholder="studio-log"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="tag-add-color">Color</label>
                    <input id="tag-add-color" name="tag_color" type="color" value="#d97706"
            ...
            <div class="flex flex-col-reverse gap-2 border-t border-stone-100 px-5 py-4 sm:flex-row sm:justify-end">
                ...
                <button type="button" class="<?= $btnPri ?> w-full sm:w-auto">Save tag</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div role="dialog" aria-modal="true" aria-labelledby="modal-tag-edit-title" tabindex="-1"
            ...
            <form class="space-y-4 px-5 py-4" action="#" method="get" onsubmit="return false;">
                <div>
                    ...
                    <input id="tag-edit-name" name="tag_name" type="text" class="<?= $fld ?>"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="tag-edit-slug">Slug</label>
                    <input id="tag-edit-slug" name="tag_slug" type="text" class="<?= $fld ?> font-mono text-xs"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="tag-edit-posts">Posts using tag</label>
                    <input id="tag-edit-posts" name="tag_posts" type="number" min="0" class="<?= $fld ?> tabular-nums"/>
                </div>
                <div>
                    <label class="<?= $lbl ?>" for="tag-edit-color">Color</label>
                    <input id="tag-edit-color" name="tag_color" type="color" value="#78716c"
                           class="mt-1.5 h-10 w-full cursor-pointer rounded-xl border border-stone-200 bg-white px-1 py-1 shadow-inner shadow-stone-900/5 focus:outline-none focus:ring-2 focus:ring-amber-500/30"/>
                </div>
            </form>
            <div class="flex flex-col-reverse gap-2 border-t border-stone-100 px-5 py-4 sm:flex-row sm:justify-end">
